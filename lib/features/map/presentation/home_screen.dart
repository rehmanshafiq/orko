...
''';
        ...
        child: BlocConsumer<MapCubit, MapState>(
          listener: (context, state) {
            if (state is MapLoaded) {
              ...
              _markers = state.locations.map(_toMarker).toSet();
              if (state.locations.isNotEmpty && _mapController != null) {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                8.horizontalSpace,
                _topActionIcon(Icons.tune_rounded,
                    isPrimary: true, isCompact: true),
              ],
            ),
          ),
        ),
  ...
  Widget _topActionIcon(IconData icon,
      {bool isPrimary = false, bool isCompact = false}) {
    return Container(
