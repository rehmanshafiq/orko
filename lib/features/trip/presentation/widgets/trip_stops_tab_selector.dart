...
class TripStopsTabSelector extends StatelessWidget {
  const TripStopsTabSelector({
    super.key,
    required this.ui,
  ...
  final TripStopsTab selectedTab;
  final ValueChanged<TripStopsTab> onTabSelected;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: TripStopsTab.values.map((tab) {
          return Expanded(
            child: _TabSegment(
              ui: ui,
              label: tab.label,
